...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001a9d, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a9c, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [810 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x1152f416bf0f0c56, ; from name: libaot-Com.Kingdee.App
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	}, ; 70
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x19fa26e68b8bcc0c, ; from name: aot-Com.Kingdee.App.so
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libaot-CommunityToolkit.Maui.Markup.dll.so
		ptr null; void* handle
	}, ; 171
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3e573d114e06dfbb, ; from name: libaot-Com.Kingdee.App.dll.so
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x613be6a648d6f62f, ; from name: Com.Kingdee.App
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x63d21a92174e82a6, ; from name: aot-Com.Kingdee.App
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x63fada5b5487ebd2, ; from name: libaot-Com.Kingdee.App.so
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb06c3c124ba5f63e, ; from name: Com.Kingdee.App.so
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc93a6c8a43a9e195, ; from name: aot-Com.Kingdee.App.dll.so
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd6d344b54f753496, ; from name: Com.Kingdee.App.dll.so
		i64 u0x3e573d114e06dfbb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Com.Kingdee.App.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.com.kingdee.app\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [30 x i8] c"libaot-Com.Kingdee.App.dll.so\00", align 16
...
@.DSOCacheEntry.11_name = private unnamed_addr constant [43 x i8] c"libaot-CommunityToolkit.Maui.Markup.dll.so\00", align 16
